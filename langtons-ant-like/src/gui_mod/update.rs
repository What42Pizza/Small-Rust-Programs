...
pub fn update_gui_elements<CustomData>(element: &mut GuiElement<CustomData>, parent_area: RealArea, keyboard_data: &KeyboardData) {
	...
	for child in &mut element.children_by_layer {
		update_gui_elements(child, current_area, keyboard_data);
	}
...
pub fn process_typing<CustomData>(element: &mut GuiElement<CustomData>, keyboard_data: &KeyboardData) {
